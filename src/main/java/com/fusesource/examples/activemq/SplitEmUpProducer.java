...
public class SplitEmUpProducer {
    private static final Log LOG = LogFactory.getLog(SplitEmUpProducer.class);
    ...
    private static final String DESTINATION_NAME = "queue/splitEmUpComplete";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (int i = 1; i <= NUM_MESSAGES_TO_BE_SENT; i++) {
                TextMessage message = session.createTextMessage(i + ". message sent from " + SplitEmUpProducer.class.getName());
